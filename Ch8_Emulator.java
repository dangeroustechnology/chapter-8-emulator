...
// TODO: consider turning I into an int. its only ever an address, so may as well remove sign difficulties

public class Ch8_Emulator {
    private int[] memory = new int[4096];   // 4k RAM
    private int[] V = new int[16];          // 8-bit registers, V0-F
    ...
    private int[] stack = new int[32];      // 16-bit stack
    private Ch8_reader fr = new Ch8_reader();
    private Ch8_display display = new Ch8_display();
    ...
    public int font_lookup(int digit) {
        ...
        switch (digit) {
            case 0x01:
                return (short) (base + 5);
            case 0x02:
                return (short) (base + 10);
            case 0x03:
                return (short) (base + 15);
            case 0x04:
                return (short) (base + 20);
            case 0x05:
                return (short) (base + 25);
            case 0x06:
                return (short) (base + 30);
            case 0x07:
                return (short) (base + 35);
            case 0x08:
                return (short) (base + 40);
            case 0x09:
                return (short) (base + 45);
            case 0x0A:
                return (short) (base + 50);
            case 0x0B:
                return (short) (base + 55);
            case 0x0C:
                return (short) (base + 60);
            case 0x0D:
                return (short) (base + 65);
            case 0x0E:
                return (short) (base + 70);
            case 0x0F:
                return (short) (base + 75);
            default:
                return base;
        }
    }
    ...
    public void load_font(String font_file) {   // TODO: actually call this in init lmao
    ...
    public void step_emu() {    // TODO: 0x00CN, FB, FC; 0xE; 0xFX0A
